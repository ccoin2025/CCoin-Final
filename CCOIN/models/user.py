...
class User(Base):
    ...
    commission_transaction_hash = Column(String, unique=True, nullable=True)  # ⭐ اضافه شده: unique=True
    ...
    transactions = relationship("Transaction", back_populates="user", cascade="all, delete-orphan")  # ⭐ جدید
    ...
    __table_args__ = (
        ...
        UniqueConstraint('commission_transaction_hash', name='uq_user_commission_hash'),  # ⭐ جدید
    )
